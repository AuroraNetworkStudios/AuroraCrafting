...
@Getter
public class FurnaceRecipeViewConfig extends AuroraConfig {
    private String title = "Furnace Recipes";
    ...
    public FurnaceRecipeViewConfig(AuroraCrafting plugin) {
        super(getFile(plugin));
    }

    public static File getFile(AuroraCrafting plugin) {
        return new File(plugin.getDataFolder() + "/" + VANILLA_RECIPE_VIEW_PATH, "furnace.yml");
    }
