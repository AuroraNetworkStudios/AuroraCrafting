...
@Getter
public class StoneCutterRecipeViewConfig extends AuroraConfig {
    private String title = "Stonecutter Recipes";
    ...
    public StoneCutterRecipeViewConfig(AuroraCrafting plugin) {
        super(getFile(plugin));
    }

    public static File getFile(AuroraCrafting plugin) {
        return new File(plugin.getDataFolder() + "/" + VANILLA_RECIPE_VIEW_PATH, "stone_cutter.yml");
    }
